...
public class Pathfinder : MonoBehaviour
{
    ...
    public Path1 FindPath(Tile origin, Tile destination)
    {
    ...
    /// <returns></returns>
    public Path1 PathBetween(Tile dest, Tile source)
    {
        Path1 path = MakePath(dest, source);
    ...
    /// <param name="origin"></param>
    /// <returns></returns>
    private Path1 MakePath(Tile destination, Tile origin)
    {
        List<Tile> tiles = new List<Tile>();
